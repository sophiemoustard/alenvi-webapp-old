...
export default {
  ...
  computed: {
    ...
    isVersionUpdated () {
      ...
      const signatureUpdated = (!!this.selectedVersion.signature && !this.editedVersion.shouldBeSigned) ||
        (!this.selectedVersion.signature && this.editedVersion.shouldBeSigned)
