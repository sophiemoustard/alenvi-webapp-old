<template>
  <div>
    <q-input color="white" inverted-light :value="formattedDate" @input="update($event, 'DD/MM/YYYY')" placeholder="jj/mm/yyyy"
      @blur="blurHandler" align="center" @focus="toggleDatetime" />
    <q-datetime :ref="name" :value="value" format="DD MMM YYYY" color="white" inverted-light @input="update" hide-underline minimal/>
  </div>
</template>
