  ...
  <div class="row justify-center layout-padding">
    <q-card class="layout-padding" style="width: 600px; max-width: 90vw;">
      ...
      <q-card-main>
        ...
        RIB
        <q-field :label-width="3" label="Titulaire du compte" :error="$v.user.rib.name.$error" error-label="Champ requis">
          <q-input type="text" v-model="user.rib.name" @blur="$v.user.rib.name" />
        </q-field>
