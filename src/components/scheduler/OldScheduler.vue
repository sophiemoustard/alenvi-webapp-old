<template>
  <div>
    <div v-if="ogustUser && title" class="row justify-between items-baseline q-pt-sm">
      ...
      <ni-sector-filter class="sector-filter" v-show="showTabFilter && !customer" v-if="ogustUser" @personChosen="applyFilter" @click.self="displayFilter" />
    </div>
