...
export default {
  ...
  methods: {
    ...
    getClientName (customer, bill) {
      return bill.thirdPartyPayer ? `${bill.thirdPartyPayer.name.length > 34 ? bill.thirdPartyPayer.name.substring(0, 35) : bill.thirdPartyPayer.name}...` : customer.identity.lastname;
    },
