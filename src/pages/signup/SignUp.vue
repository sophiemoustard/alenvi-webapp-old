       ...
       <q-card flat style="width: 700px; max-width: 90vw;">
        ...
        <q-card-main>
          <q-stepper color="primary" ref="stepper" alternative-labels vertical>
            <!-- First step -->
            <q-step name="first" title="Informations personnelles" default>
            ...
            <!-- Last step -->
            <q-step name="fourth" title="Documents">
  ...
  computed: {
    ...
    hasStep1Errors () {
      return this.$v.user.civility.$invalid ? true : this.$v.user.firstname.$invalid ? true : this.$v.user.lastname.$invalid ? true
        : this.$v.user.address.line.$invalid ? true : this.$v.user.address.zipCode.$invalid ? true
          : this.$v.user.address.city.$invalid ? true : this.$v.user.address.city.$invalid ? true
    ...
    async secondStep () {
      try {
        ...
        this.$q.notify({
          color: 'error',
          icon: 'warning',
          detail: "Erreur lors de l'enregistrement des informations de l'utilisateur",
          position: 'bottom-right',
          timeout: 2500
        });
      }
