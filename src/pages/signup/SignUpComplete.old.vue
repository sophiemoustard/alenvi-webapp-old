            ...
            <q-stepper color="primary" ref="stepper" alternative-labels vertical>
              ...
              <q-step name="third" title="Documents obligatoires">
                ...
                <q-field icon="mdi-account-card-details" :error="$v.user.administrative.idCard.$error" error-label="Champ requis">
                  <q-uploader v-if="storedUser && !storedUser.administrative.idCardRecto.link" name="idCardRecto" :url="docsUploadUrl" :headers="headers"
                  ...
                  <p class="upload-done" v-if="storedUser && storedUser.administrative.idCardRecto.link">Fichier mis en ligne <q-icon name="check" /></p>
                  <p class="upload-not-done" v-if="storedUser && !storedUser.administrative.idCardRecto.link && !hasPickedIdCardRecto">Fichier manquant <q-icon name="warning" /></p>
                ...
                <q-field icon="mdi-account-card-details" :error="$v.user.administrative.idCard.$error" error-label="Champ requis">
                  <q-uploader v-if="storedUser && !storedUser.administrative.idCardVerso.link" name="idCardVerso" :url="docsUploadUrl" :headers="headers"
                  ...
                  <p class="upload-done" v-if="storedUser && storedUser.administrative.idCardVerso.link">Fichier mis en ligne <q-icon name="check" /></p>
                  <p class="upload-not-done" v-if="storedUser && !storedUser.administrative.idCardVerso.link && !hasPickedIdCardVerso">Fichier manquant <q-icon name="warning" /></p>
                ...
                <q-field icon="mdi-account-card-details" :error="$v.user.administrative.vitalCard.$error" error-label="Champ requis">
                  <q-uploader v-if="storedUser && !storedUser.administrative.vitalCard.link" name="vitalCard" :url="docsUploadUrl" :headers="headers"
                  ...
                  <p class="upload-done" v-if="storedUser && storedUser.administrative.vitalCard.link">Fichier mis en ligne <q-icon name="check" /></p>
                  <p class="upload-not-done" v-if="storedUser && !storedUser.administrative.vitalCard.link && !hasPickedVitalCard">Fichier manquant <q-icon name="warning" /></p>
